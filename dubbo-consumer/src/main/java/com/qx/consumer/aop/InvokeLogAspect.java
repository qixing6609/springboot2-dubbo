...
//import com.ts.common.token.Token;
//import com.ts.common.token.TokenUtils;
//import com.ts.common.utils.IpConvert;
//import com.ts.common.utils.StringUtils;
//import com.ts.common.utils.ThreadContent;
//import com.ts.core.sunshine.model.User;
//
//@Aspect
//@Component
...
//    @Pointcut("execution(* com.ts.sunshine.controller.*.*(..))")
...
//		if (user != null) {
//			logger.info("用户：id:{},phone:{},token:{}", user.getId(), user.getPhone(), token);
//		}
//
//        // 获取访问java方法
...
//        if (consumTime < DEFAULT_TIME_LIMIT)
//        	logger.info(MSG, new Object[]{request.getRequestURI(), IpConvert.getIpAddr(request), request.getMethod(), headers, function, params, getReturnMsg(printReturn, returnObj), consumTime});
//        else
//        	logger.warn(MSG, new Object[]{request.getRequestURI(), IpConvert.getIpAddr(request), request.getMethod(), headers, function, params, getReturnMsg(printReturn, returnObj), consumTime});
//    }
//
//    /**
//     * @param name            操作名称
